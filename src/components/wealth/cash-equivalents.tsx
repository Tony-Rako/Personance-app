      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="p-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">
              You&apos;re close to your emergency fund goal. Consider adding{' '}
              {formatCurrency(3000)} more.
            </p>
          </div>
        </Card>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">
              Your positive cash flow allows for {formatCurrency(1120)} in
              additional savings or investments monthly.
            </p>
          </div>
        </Card>
      </div>
