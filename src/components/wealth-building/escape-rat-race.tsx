  ...
  return (
    <Card className="p-6">
      ...
      <p className="text-gray-600 mb-6">
        When your passive income exceeds your expenses, you achieve financial
        freedom
      </p>
      ...
      <div className="space-y-6">
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm text-gray-600">
              {formatAmount(passiveIncome)} of{' '}
              {formatAmount(targetPassiveIncome)}
            </span>
          </div>
          <Progress value={progressPercentage} className="h-3 mb-2" />
          <p className="text-sm text-gray-600">
            {formatPercentage(progressPercentage)} complete •{' '}
            {formatAmount(targetPassiveIncome - passiveIncome)} remaining
          </p>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm text-gray-600">
              {formatAmount(passiveIncome)} covers{' '}
              {formatPercentage(expensesCoverage)} of expenses
            </span>
          </div>
          <Progress
            value={Math.min(expensesCoverage, 100)}
            className="h-3 mb-2"
          />
          <p className="text-sm text-gray-600">
            ...
            <div>
              ...
              {expensesCoverage >= 100 ? (
                ...
                <p className="text-sm text-blue-800 mt-1">
                  You need {formatAmount(monthlyExpenses - passiveIncome)} more
                  in monthly passive income to achieve financial freedom.
                </p>
              )}
            </div>
          </div>
        ...
        <div>
          <h4 className="font-semibold text-gray-900 mb-3">
            Next Steps to Build Passive Income
          </h4>
          <div className="space-y-2">
            <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
              <PiggyBank className="h-4 w-4 text-blue-600" />
              <p className="text-sm text-gray-700">
                Increase emergency fund to invest in income-producing assets
              </p>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-700">
                Explore dividend-paying stocks and index funds
              </p>
            </div>
          </div>
        </div>
