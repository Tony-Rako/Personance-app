    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <MetricCard
          ...
          description={
            summary.totalIncome === 0
              ? 'Add income sources to start tracking your earnings'
        ...
        <MetricCard
          ...
          description={
            summary.cashFlow < 0
              ? 'Add income sources to improve your cash flow'
              : summary.totalIncome === 0
                ? 'Add income sources to start tracking cash flow'
