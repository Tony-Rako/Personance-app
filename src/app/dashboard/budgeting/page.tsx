...
function BudgetTips() {
  const tips = [
    {
      ...
      description: "You're currently $1,150 under your monthly budget. Great job keeping expenses in check!",
      type: "success"
    },
    {
      icon: <AlertCircle className="h-5 w-5 text-blue-600" />,
      title: "Budget Tip",
      description: "Consider allocating your remaining funds toward savings or paying down debt to improve your financial health.",
      type: "info"
    }
  ]
  ...
  return (
    <Card className="p-6">
      <h3 className="text-lg font-semibold text-gray-900 mb-4">Spending Goals</h3>
    ...
    <Card className="p-6">
      ...
      <div className="space-y-4">
        {goals.map((goal, index) => {
          const progress = goal.allocated > 0 ? (goal.spent / goal.allocated) * 100 : 0
          const isOverBudget = goal.spent > goal.allocated
          const usageText = goal.allocated > 0 ? `${Math.round(progress)}% used` : "0% used"
            ...
            <div key={index} className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-gray-600">
                  {formatCurrency(goal.spent)} of {formatCurrency(goal.allocated)}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className={`${
                  ...
                  progress === 0 ? 'text-gray-500' : 'text-gray-700'
                }`}>
                  {usageText}
                </span>
              </div>
