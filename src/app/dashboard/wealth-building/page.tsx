...
export default function WealthBuildingPage() {
  ...
  const incomeData = [
    { id: 1, name: "Police Officer Salary", amount: 3000, frequency: "monthly" },
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Apply Rich Dad Poor Dad principles to build lasting wealth and achieve financial freedom.
        </p>
      </div>
              ...
              <div className="border-t pt-4">
                <div className="border border-blue-200 rounded-lg p-3">
                  <div className="flex items-center justify-between">
                    <span className="text-blue-600 font-medium">Real Estate/Business</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <p className="font-medium text-gray-900">Increase Passive Income To Escape The Rat Race</p>
                  <span className="text-sm text-gray-600">
                    {formatCurrency(passiveIncomeGoal.current)} of {formatCurrency(passiveIncomeGoal.target)}
                  </span>
                </div>
                <Progress value={passiveIncomeGoal.progress} className="h-2 mb-2" />
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <Card className="p-6">
          ...
          {assets.map((asset, index) => (
            <div key={index} className="py-3 border-b border-gray-200 last:border-b-0">
              ...
              <p className="text-sm text-gray-500 mt-1">+ Add {asset.category}</p>
            </div>
          ))}
        </Card>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="pt-2">
              <p className="text-sm text-gray-500">Click to add new liability</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <p className="text-2xl font-bold text-red-600">{formatCurrency(netCashFlow)}</p>
      ...
      <Card className="p-6 bg-purple-50 border-purple-200">
        <h3 className="text-lg font-semibold text-purple-900 mb-2">Rich Dad Definition</h3>
        <p className="text-sm text-purple-800">
          <strong>Asset:</strong> Puts money in your pocket. <strong>Liability:</strong> Takes money out of your pocket. The rich buy assets, the poor and middle class buy liabilities they think are assets.
        </p>
      </Card>
    </div>
  )
